...
const messages = {
  zh: {
    nav: { dashboard: '总览', devices: '设备', 'device-detail': '设备详情', agent: 'AI助手', tasks: '任务', settings: '设置', logs: '日志', help: '帮助' },
  ...
  en: {
    nav: { dashboard: 'Overview', devices: 'Devices', 'device-detail': 'Device Detail', agent: 'Agent', tasks: 'Tasks', settings: 'Settings', logs: 'Logs', help: 'Help' },
