...
const messages = {
  zh: {
    nav: { dashboard: '总览', devices: '设备', agent: 'Agent', tasks: '任务', settings: '设置' },
    auth: { password: '管理员密码', login: '登录' },
    states: { Offline: '未连接', Unauthorized: '待授权', Matched: 'ADB 已连接', Online: '已连接', Protected: '异常保护', Updating: '更新中' },
    settings: { general: '常规', network: '网络', security: '安全', devices: '设备', media: '投屏', automation: '自动化', agent: 'AI Agent', advanced: '高级', logs: '日志' },
  },
  en: {
